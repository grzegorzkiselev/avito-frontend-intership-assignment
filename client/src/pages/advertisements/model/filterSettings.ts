...
// Number(currentUrl.searchParams.get("min-priceRange"))
const ranges = [
  {
    id: "priceRange",
    field: "price",
...
//   const { minValueItem, maxValueItem, isMinMaxValuesLoading, minMaxValueError } = useGetMinMaxValues(ADVERTISEMENTS_PROPS.endpoint, field);
